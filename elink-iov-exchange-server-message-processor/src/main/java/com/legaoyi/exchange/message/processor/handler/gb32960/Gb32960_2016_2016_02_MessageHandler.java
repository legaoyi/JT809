...
public class Gb32960_2016_2016_02_MessageHandler extends MessageHandler {

    private static final Logger logger = LoggerFactory.getLogger(Gb32960_2016_2016_02_MessageHandler.class);
    ...
    public void handle(ExchangeMessage exchangeMessage) throws Exception {
        ...
        logger.info("******gb32960，车辆实时数据,message={}", exchangeMessage);
    }
