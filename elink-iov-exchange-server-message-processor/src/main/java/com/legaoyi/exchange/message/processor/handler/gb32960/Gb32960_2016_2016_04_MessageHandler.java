...
@Component(Constants.ELINK_MESSAGE_PROCESSOR_BEAN_PREFIX + "gb32960_2016_04" + Constants.ELINK_MESSAGE_PROCESSOR_MESSAGE_HANDLER_BEAN_SUFFIX)
public class Gb32960_2016_2016_04_MessageHandler extends MessageHandler {

    private static final Logger logger = LoggerFactory.getLogger(Gb32960_2016_2016_04_MessageHandler.class);
    ...
    public void handle(ExchangeMessage exchangeMessage) throws Exception {
        ...
        logger.info("******gb32960,车辆登出消息,message={}", exchangeMessage);
    }
