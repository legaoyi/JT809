...
public class JTT809_1001_MessageHandler extends MessageHandler {

    private static final Logger logger = LoggerFactory.getLogger(JTT809_1001_MessageHandler.class);
    ...
    public void handle(ExchangeMessage exchangeMessage) throws Exception {
        ...
        Long accessCode = Long.parseLong(String.valueOf(messageHeader.get("accessCode")));
