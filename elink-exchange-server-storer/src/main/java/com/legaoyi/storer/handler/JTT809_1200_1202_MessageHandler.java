...
public class JTT809_1200_1202_MessageHandler extends MessageHandler {

    private static final Logger logger = LoggerFactory.getLogger(JTT809_1200_1202_MessageHandler.class);
