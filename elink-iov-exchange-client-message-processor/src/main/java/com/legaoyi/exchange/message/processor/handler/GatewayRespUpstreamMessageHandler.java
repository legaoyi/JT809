 ...
 *
 */
@Component("gatewayRespUpstreamMessageHandler")
public class GatewayRespUpstreamMessageHandler extends MessageHandler {

    private static final Logger logger = LoggerFactory.getLogger(GatewayRespUpstreamMessageHandler.class);
