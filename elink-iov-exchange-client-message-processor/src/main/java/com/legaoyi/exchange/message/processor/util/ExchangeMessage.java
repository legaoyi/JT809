...
public class ExchangeMessage implements Serializable {
    ...
    /** 业务平台向数据交换网关发送的上行消息 **/
    public static final String MESSAGEID_EXCHANGE_DOWNSTREAM_MESSAGE = "9000";

    /** 业务平台向数据交换网关发送接入平台消息 **/
    public static final String MESSAGEID_EXCHANGE_GNSS_CENTER_INFO_RESP_MESSAGE = "9001";

    /** 业务平台向数据交换网关发送链路管理消息 **/
    public static final String MESSAGEID_EXCHANGE_LINK_STATUS_MESSAGE = "9002";

    /** 数据交换网关向业务平台向发送请求上报接入平台信息消息 **/
    public static final String MESSAGEID_EXCHANGE_GNSS_CENTER_INFO_REQUEST_MESSAGE = "1001";

    /** 数据交换网关向业务平台发送的下行消息 **/
    public static final String MESSAGEID_EXCHANGE_UPSTREAM_MESSAGE = "1000";
