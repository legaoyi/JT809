 ...
 *
 */
@Component("dwonstreamMessageHandler")
public class DwonstreamMessageHandler extends MessageHandler {

    private static final Logger logger = LoggerFactory.getLogger(DwonstreamMessageHandler.class);
